...
const dict = {
  ...
  'table.opportunity': { pt: 'Opportunity', en: 'Opportunity', es: 'Opportunity' },
  'table.cpopportunity': { pt: 'CP Opportunity', en: 'CP Opportunity', es: 'CP Opportunity' },
  'table.customer': { pt: 'Customer', en: 'Customer', es: 'Customer' },
  'table.cpcustomer': { pt: 'CP Customer', en: 'CP Customer', es: 'CP Customer' },
  ...
  'leadsAttribution.opportunity': { pt: 'Opportunity', en: 'Opportunity', es: 'Opportunity' },
  'leadsAttribution.customer': { pt: 'Customer', en: 'Customer', es: 'Customer' },
